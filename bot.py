"""
Discord Bot for GeoVigilant OS - Sends embedded messages and alerts to Discord channel
"""
    ...
    async def send_embedded_message(self, 
        ...
        try:
            ...
            if footer:
                ...
                embed.set_footer(text="GeoVigilant OS Intelligence System")
    ...
    try:
        ...
        if bot_manager.channel:
            ...
            await bot_manager.send_alert(
                "BOT_STARTUP",
                "GeoVigilant OS Discord Bot initialized and ready for operation",
                "INFO"
            )
        else:
