...
import { globeCache, DEFAULT_TTLS } from './globeCache.js';
...
export class APIService {
    ...
    static async fetchFlights() {
        return globeCache.fetchWithCache('flights', async () => {
            try {
    ...
    static async fetchSatellites() {
        return globeCache.fetchWithCache('satellites', async () => {
            try {
    ...
    static async fetchEarthquakes() {
        return globeCache.fetchWithCache('earthquakes', async () => {
            try {
    ...
    static async fetchWeatherAlerts() {
        return globeCache.fetchWithCache('weatherAlerts', async () => {
            try {
    ...
    static async fetchNaturalEvents() {
        return globeCache.fetchWithCache('naturalEvents', async () => {
            try {
    ...
    static async fetchVessels() {
        return globeCache.fetchWithCache('vessels', async () => {
            try {
    ...
    static async fetchCCTV(lat, lon, altM = 10_000_000, category = '') {
        ...
        const cacheKey = `cctv:${Number(lat).toFixed(1)}:${Number(lon).toFixed(1)}:${Math.round(altM / 100000)}:${category}`;

        return globeCache.fetchWithCache(cacheKey, async () => {
            try {
    ...
    static async fetchNASA_FIRMS() {
        return globeCache.fetchWithCache('wildfires', async () => {
            try {
    ...
    static async fetchSpaceWeather() {
        return globeCache.fetchWithCache('spaceWeather', async () => {
            try {
    ...
    static async fetchEmergencySquawks() {
        return globeCache.fetchWithCache('squawks', async () => {
            try {
