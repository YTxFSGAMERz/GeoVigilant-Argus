export class SpatialTemporalAnomalyDetector {
  constructor() {
    ...
    this.TEMP_MEAN = 24.0;
    this.TEMP_STD = 3.0;
    this.MAX_SPEED_MPS = 45.0; // 162 km/h - limit for stationary/ground nodes
    this.EXPECTED_INTERVAL_MS = 2000;
  }

  /**
   * Evaluates event for spatial, behavioral, and temporal anomalies.
   * @param {Object} event
   * @returns {Object}
   */
  evaluate(event) {
    ...
    // 2. Kinematic Velocity Bound (Haversine calculation)
