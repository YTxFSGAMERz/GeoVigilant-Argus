export const MAP_DATA = {
    ...
    MILITARY_BASES: [
        ...
        { id: 'al_udeid', name: 'Al Udeid AB Qatar', lat: 25.12, lon: 51.31, type: 'us-nato' },
        { id: 'al_dhafra', name: 'Al Dhafra AB UAE', lat: 24.25, lon: 54.55, type: 'us-nato' },
        { id: 'camp_lemonnier', name: 'Camp Lemonnier Djibouti', lat: 11.55, lon: 43.14, type: 'us-nato' },
        { id: 'misawa', name: 'Misawa AB Japan', lat: 40.7, lon: 141.37, type: 'us-nato' },
        { id: 'osan', name: 'Osan AB South Korea', lat: 37.09, lon: 127.03, type: 'us-nato' },
        { id: 'spangdahlem', name: 'Spangdahlem AB Germany', lat: 49.97, lon: 6.69, type: 'us-nato' },
        { id: 'aviano', name: 'Aviano AB Italy', lat: 46.03, lon: 12.60, type: 'us-nato' },
        { id: 'sigonella', name: 'NAS Sigonella Italy', lat: 37.40, lon: 14.92, type: 'us-nato' },
        { id: 'thule', name: 'Thule AB Greenland', lat: 76.53, lon: -68.74, type: 'us-nato' },
        { id: 'joint_base_lewis', name: 'Joint Base Lewis-McChord', lat: 47.04, lon: -122.58, type: 'us-nato' },
        { id: 'fort_liberty', name: 'Fort Liberty (Bragg)', lat: 35.14, lon: -79.0, type: 'us-nato' },
        { id: 'pearl_harbor', name: 'Pearl Harbor-Hickam', lat: 21.35, lon: -157.97, type: 'us-nato' },
        { id: 'raf_lakenheath', name: 'RAF Lakenheath UK', lat: 52.41, lon: 0.56, type: 'us-nato' },
        { id: 'raf_mildenhall', name: 'RAF Mildenhall UK', lat: 52.36, lon: 0.49, type: 'us-nato' },
        { id: 'guantanamo', name: 'Guantanamo Bay', lat: 19.9, lon: -75.1, type: 'us-nato' },
        { id: 'fort_campbell', name: 'Fort Campbell', lat: 36.67, lon: -87.47, type: 'us-nato' },
        { id: 'edwards_afb', name: 'Edwards AFB', lat: 34.90, lon: -117.88, type: 'us-nato' },
        { id: 'cia_langley', name: 'CIA Langley', lat: 38.95, lon: -77.15, type: 'us-nato' },
        { id: 'nsa_ft_meade', name: 'NSA Fort Meade', lat: 39.11, lon: -76.77, type: 'us-nato' },
        { id: 'pentagon', name: 'The Pentagon', lat: 38.87, lon: -77.06, type: 'us-nato' },
        { id: 'area_51', name: 'Area 51 (Groom Lake)', lat: 37.24, lon: -115.82, type: 'us-nato' },
        { id: 'sanya', name: 'Sanya Naval Base', lat: 18.22, lon: 109.49, type: 'china' },
        { id: 'ningbo', name: 'Ningbo Naval Base', lat: 29.92, lon: 121.57, type: 'china' },
        { id: 'qingdao', name: 'Qingdao Naval HQ', lat: 36.06, lon: 120.35, type: 'china' },
        { id: 'zhanjiang', name: 'Zhanjiang Naval Base', lat: 21.23, lon: 110.4, type: 'china' },
        { id: 'djibouti_china', name: 'China PLA Djibouti', lat: 11.53, lon: 43.10, type: 'china' },
        { id: 'fiery_cross', name: 'Fiery Cross Reef SCS', lat: 9.55, lon: 112.89, type: 'china' },
        { id: 'subi_reef', name: 'Subi Reef SCS', lat: 10.93, lon: 114.08, type: 'china' },
        { id: 'mischief_reef', name: 'Mischief Reef SCS', lat: 9.9, lon: 115.53, type: 'china' },
        { id: 'woody_island', name: 'Woody Island (Paracel)', lat: 16.83, lon: 112.35, type: 'china' },
        { id: 'tartus', name: 'Tartus Naval Base Syria', lat: 34.9, lon: 35.86, type: 'russia' },
        { id: 'kamchatka', name: 'Petropavlovsk-Kamchatsky', lat: 52.97, lon: 158.65, type: 'russia' },
        { id: 'arctic_trefoil', name: 'Arctic Trefoil Base', lat: 80.78, lon: 58.03, type: 'russia' },
        { id: 'ins_karwar', name: 'INS Karwar Naval Base', lat: 14.82, lon: 74.12, type: 'india' },
        { id: 'ins_andaman', name: 'INS Andaman Naval', lat: 11.67, lon: 92.72, type: 'india' },
        { id: 'sinpo_sub', name: 'Sinpo Submarine Base', lat: 40.01, lon: 128.18, type: 'north-korea' },
        { id: 'nampo_naval', name: 'Nampo Naval Base', lat: 38.75, lon: 125.43, type: 'north-korea' },
        { id: 'pyongsong_missile', name: 'Pyongsong Missile Site', lat: 39.25, lon: 125.86, type: 'north-korea' },
        { id: 'porkkala_fin', name: 'Porkkala Naval Base (Finland)', lat: 60.0, lon: 24.43, type: 'us-nato' },
        { id: 'tallinn', name: 'Tallinn NATO Base Estonia', lat: 59.44, lon: 24.75, type: 'us-nato' },
        { id: 'erbil', name: 'Erbil Air Base Iraq', lat: 36.24, lon: 44.09, type: 'us-nato' },
        { id: 'ain_al_asad', name: 'Ain al-Asad Air Base Iraq', lat: 33.79, lon: 42.44, type: 'us-nato' }
    ],
    ...
    STRATEGIC_WATERWAYS: [
        ...
        { id: 'drake_passage', name: 'Drake Passage', lat: -58.0, lon: -68.0, dailyTraffic: 'Moderate', description: 'Southern Ocean route, strategic bottleneck' },
        { id: 'lombok', name: 'Lombok Strait', lat: -8.75, lon: 115.75, dailyTraffic: 'High', description: 'Alternative to Malacca for deep-draft vessels' },
        { id: 'luzon', name: 'Luzon Strait', lat: 20.5, lon: 121.5, dailyTraffic: 'High', description: 'Key Pacific strategic waterway' },
        { id: 'danish_straits', name: 'Danish Straits', lat: 55.7, lon: 12.0, dailyTraffic: '60k vessels/year', description: 'Baltic Sea gateway' },
        { id: 'strait_sicily', name: 'Strait of Sicily', lat: 37.2, lon: 11.0, dailyTraffic: 'Very High', description: 'Mediterranean East-West divide' }
    ],
